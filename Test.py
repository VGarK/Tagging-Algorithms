...
Options = {'colorspace':'HSV', 'K':6, 'km_init':'random', 'fitting':'Fisher', 'single_thr':0.6, 'metric':'basic', 'verbose':False}
lab1,ind1,k_m = lb.processImage(im, Options)
Options = {'colorspace':'RGB', 'K':0, 'km_init':'first', 'fitting':'Fisher', 'single_thr':0.6, 'metric':'basic', 'verbose':False}
